...
const UpdatePackage = oldPackage => {
  ...
  const [packageData, setPackageData] = useState({
    name: oldPackage.oldPackage.name,
    description: oldPackage.oldPackage.description,
    city: oldPackage.oldPackage.city,
    startDate: oldPackage.oldPackage.startDate,
    endDate: oldPackage.oldPackage.endDate,
    isActive: oldPackage.oldPackage.isActive,
    // imageUrl: "",
    otherFacilites: oldPackage.oldPackage.otherFacilites,
    totalAmount: oldPackage.oldPackage.totalAmount,
    noOfPersons: oldPackage.oldPackage.noOfPersons,
    // travelAgency: "",
    hotel: "",
    disabled: oldPackage.oldPackage.disabled,
    ratings: oldPackage.oldPackage.ratings,
    reviews: oldPackage.oldPackage.reviews,
    avgRating: oldPackage.oldPackage.avgRating,
    counttotalbookings: oldPackage.oldPackage.counttotalbookings,
    packageCategory: oldPackage.oldPackage.packageCategory,
  });
  ...
  const mutation = useUpdatePackage(oldPackage.oldPackage._id);
  ...
  const checkData = async () => {
    ...
    try {
      await mutation.mutateAsync({ ...packageData });
