                    ...
                    <div className="interaction-section">
                        ...
                        {feedbackType === FeedbackType.PACKAGE_OWNER && (
                            <>
                                ...
                                <button onClick={() => handleAddRating(booking._id)
                                }
                                    style={{
                                        width: "20%",
                                    }}
                                ...
                                />
                                <button onClick={() => handleAddReview(booking._id)}
                                    style={{
                                        width: "99%",
                                    }}
                                >Add Review</button>
                                ...
                                />
                                <button onClick={() => handleSendFeedback(booking._id)}
                                    style={
                                        {
                                            width: "99%",
                                        }
                        ...
                        {feedbackType === FeedbackType.HOTEL && (
                            <>
                                ...
                                <input
                                    ...
                                    placeholder="Add a review"
                                />
                                <button onClick={() => handleAddHotelReview(booking.travelAgencyId)}
